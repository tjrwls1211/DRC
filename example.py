...
# 이미지 로드
accel_img_normal = ImageTk.PhotoImage(Image.open("accel_normal.png").resize((320, 500)))
accel_img_dark = ImageTk.PhotoImage(Image.open("accel_dark.png").resize((320, 500)))
brake_img_normal = ImageTk.PhotoImage(Image.open("brake_normal.png").resize((320, 500)))
brake_img_dark = ImageTk.PhotoImage(Image.open("brake_dark.png").resize((320, 500)))
